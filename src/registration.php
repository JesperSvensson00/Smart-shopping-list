...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $reg = insertUser($username, $password);
  ...
  <head>
    ...
    <script>
      function checkConfirm(form){
        ...
        document.getElementById("error").innerText = "Lösenorden är inte samma"
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 text-center mt-4">
          <form class="form-signin" method="post" action="registration.php" onsubmit="return checkConfirm()" >
